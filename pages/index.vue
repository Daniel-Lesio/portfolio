<template>
  <div>
    <PageHeader :url='url' :urlMini='urlMini'>
        <h1 class="text-6xl text-white font-bold " >{{pageName}}</h1>
        <h2 class="text-gray-400 text-2xl font-bold tracking-widest	">FullStack Developer</h2>        
...
export default {
  data(){
    return{
      url : require(`../assets/headers/index.jpg`),
      urlMini :  require(`../assets/headers/index-mini.jpg`)
    }
  },
  computed : {
    menuOpen(){
    ...
    pageName(){
        return this.$store.state.language === "polish" ? 'Daniel' : 'Daniel' 
    }
  },
  components : {},
  methods : {
